...
public class SubcontractorService
{
    ...
    public async Task<JobListingDetailResponse> GetJobDetailAsync(Guid jobId)
    {
        ...
        return new JobListingDetailResponse
        {
            ...
            Currency = job.Currency, Status = job.Status, OfferCount = job.OfferCount, Deadline = job.Deadline, CreatedAt = job.CreatedAt,
    ...
    public async Task<OfferResponse> CreateOfferAsync(Guid userId, Guid jobId, CreateOfferRequest req)
    {
        ...
        {
            UserId = agentUserId, Type = "NEW_OFFER", Title = "Yeni Teklif",
    ...
    public async Task<JobReportResponse> UploadReportAsync(Guid userId, Guid assignedJobId, string fileName, string fileUrl, long? fileSize, string? fileType)
    {
        ...
        _db.Notifications.Add(new Notification
        {
            UserId = agentUserId, Type = "NEW_REPORT", Title = "Yeni Rapor Yüklendi",
    ...
    {
        Id = o.Id, JobId = o.JobId, JobTitle = o.JobListing?.Title ?? string.Empty,
        SubcontractorId = o.SubcontractorId, SubcontractorCompanyName = o.Subcontractor?.CompanyName ?? string.Empty,
        SubcontractorLogoUrl = o.Subcontractor?.LogoUrl, SubcontractorRating = o.Subcontractor?.Rating ?? 0,
        Price = o.Price, Currency = o.Currency, EstimatedDays = o.EstimatedDays, CoverNote = o.CoverNote, Status = o.Status, CreatedAt = o.CreatedAt
    };
